...
public class ModIntBindDataPropertyDrawer : ModPropertyDrawer
{
    private string _drawerName;
    private UIComIntBindDataDrawer Drawer => (UIComIntBindDataDrawer)Component;
    ...
    public ModIntBindDataPropertyDrawer(string drawerName,Action<int> setter,Func<int> getter,
    ...
    {
        var drawer = UIComIntBindDataDrawer.CreateInstance();
